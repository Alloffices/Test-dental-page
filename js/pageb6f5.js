...
$(document).ready(function(){
	...
	$("#insta-contactus,.cont-us-pop-ovrl,.closepop").on("click", function(){
		$('body,#cont-us-pop').toggleClass("show-con");
	});
	...
	$("#cemail2,#cname2,#cphone2").on("keyup", function(){
		if(validateInput($("#cname2")) && validateInput($("#cphone2")) && (validateEmail($("#cemail2")))){
			$("#sendcontactform2").addClass("cansend");
		}else{
			$("#sendcontactform2").removeClass("cansend");
		}
	});
	...
	$("#sendcontactform2").on("click", function(){
		if(!$(this).hasClass("cansend"))
			return;
		$("#sendcontactform2 .loading-icon").show();
		...
		if( !name.hasClass("error") && !email.hasClass("error") && !phone.hasClass("error") ){
			$.post(base_url+"/site/sendcontact",{
				...
				if(data=='ok'){
					...
					$("#sendcontactform2").removeClass("cansend");
					$("#ctext2").val("");
					$("#popform .thanks-for-contact").fadeIn(500);
					$("#popform .form-err").hide();
					setTimeout(function(){ 
						$(".thanks-for-contact").fadeOut(500);
						$('body,#cont-us-pop').removeClass("show-con");
					}, 3000);
				}else{
					$("#popform .thanks-for-contact").hide();
					$("#popform .form-err").html('There was an unexpected error. <br />Please, contact our developers on support@cstudios.sk').fadeIn(500);
				}
				$("#sendcontactform2 .loading-icon").hide();
			});
		}else{
			$("#sendcontactform2 .loading-icon").hide();
		}
...
var youtube_vid_id = 'sf3m0I0-m60';
